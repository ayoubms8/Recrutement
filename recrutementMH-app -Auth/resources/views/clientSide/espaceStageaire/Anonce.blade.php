...
<header>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
		  ...
		  <li class="nav-item active">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{url('/Recrutment')}}">Recrutements</a>
            </li>
            @if(Route::has('login'))
            @auth
  ...
  <head>
	...
	<body class="m-2" style="width: 100%;background-color: #80808017">
		...
		@foreach ($annoces as $an)
			...
			<center style="background-color:white" class="m-5">
				<form class="d-flex flex-column flex-md-row border rounded mr-10 p-4" method="get" action="{{ route('anonce.indexStageaire') }}">
					@csrf
