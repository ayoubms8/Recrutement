...
<form action="{{ route('anonce.store') }}" method="POST" id="id-annonce-Form">
   @csrf
   <input type="text" hidden value="S" name="Type">
   <section class="content">
      <!-- Infos recrutement -->
      <div class="card card-default">
         <div class="card-header">
            <h3 class="card-title">Infos Stage</h3>
         ...
         <div class="card-body">
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  <div class="form-group">
                     <div class="col-md-12">
                        <div class="form-group">
                           <label>Ecole ou l'Universite *</label>
                           <input type="text" class="form-control" id="titre" name="titre" placeholder="Enter votre ecole">
                        </div>
                     </div>
                  </div>
                  <div class="form-group">
            ...
            <input type="submit" name="submit" class="submit btn btn-success" value="Enregistrer" id="submit-annonce" />
         </div>
         <!-- /.card-body -->
         <div class="card-footer">
            Information sure l'Annonce du Stage
         </div>
      </div>
      <!-- /.card -->
