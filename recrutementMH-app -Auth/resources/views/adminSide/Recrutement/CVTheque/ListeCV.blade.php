        ...
        <div class="card-body pb-0">
          <div class="row ">
            @foreach ($CVs as $cv)
               ...
               <div class="card bg-light d-flex flex-fill click-target" data-id="{{$cv['id']}}">
                    ...
                    <div class="text-right">
                        ...
                        <a href="/dashboard/profile/{{$cv['id']}}" class="btn btn-sm btn-primary">
                        <i class="fas fa-user"></i> Profile
                        </a>
                        <br><br>
                        <a href="/dashboard/liste-cv-accept/{{$cv['id']}}" class="card-link text-success"> Accepter poste </a>
                        <a href="/dashboard/liste-cv-refuse/{{$cv['id']}}" class="card-link text-danger"> Refuser </a>
                        <br>
                    </div>
                    </div>
